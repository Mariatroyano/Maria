...
const sequelize = new Sequelize("user", "maria", "12345678", {
  host: "localhost",
  dialect: "postgres",
  logging: false,
});
...
// const sequelize = new Sequelize("user", "postgres", "postgres", {
//   host: "localhost",
//   dialect: "postgres",
//   logging: false,
// });
...
app.post("/cliente", async (req, res) => {
  const { name, email } = req.body;
  try {
    const newCliente = await cliente.create({ name, lastname,  Age,email ,  Phone, address});
